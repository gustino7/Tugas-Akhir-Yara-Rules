...
if __name__ == '__main__':
    ...
    malware_directory = './Testing_File'         # Ganti dengan direktori malware Anda
    rules_directory = './Testing_YaraRules/YaraRules_Baru'            # Ganti dengan direktori yang berisi YARA rules Anda
